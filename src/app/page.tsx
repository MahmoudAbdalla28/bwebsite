...
import HowWeEngageSection from "@/components/HowWeEngageSection";
      ...
      <main>
        ...
        <section className="py-24 md:py-32 bg-bg">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <a href="/bastion/platform/" className="group block rounded-2xl border border-border bg-white overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20 cursor-pointer">
              ...
              <img src="/bastion/assets/livedashboard.png" alt="Bastion fleet monitoring dashboard" className="w-full" />
            </a>
          </div>
        </section>
        <ReportSection />
