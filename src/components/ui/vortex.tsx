...
export const Vortex = (props: VortexProps) => {
  ...
  const draw = (canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D) => {
    ...
    // Skip the fillRect when transparent so the page background shows through.
  ...
  const renderGlow = (canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D) => {
    // Single blur+lighter compositing pass instead of two — second pass was
    // visually subtle but doubled the per-frame cost.
    ctx.save();
