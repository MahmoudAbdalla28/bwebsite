...
export default function Navbar({ heroTheme = "light" }: { heroTheme?: "light" | "dark" }) {
  ...
  return (
    <motion.nav
      ...
      className="absolute top-3 md:top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-1.5rem)] md:w-[calc(100%-3rem)] max-w-7xl rounded-2xl bg-white/95 backdrop-blur-xl border border-gray-200/70 shadow-lg shadow-gray-900/5"
    >
